...
public class EditSectionPageController {
    ...
    public void get(UiSessionContext sessionContext, PageModel model,
                    ...
                    @SpringBean("adminService") AdministrationService administrationService) throws IOException {

        sessionContext.requireAuthentication();

        // add icrc specific attributes
        IcrcRegisterPatientUtil.addICRCSpecificModelAttributes(model, patient);
    ...
    public String post(UiSessionContext sessionContext, PageModel model,
                       ...
                       UiUtils ui,
                       @SpringBean("patientValidator") PersonService personService
    		) throws IOException {
        ...
        // add icrc specific fields
		IcrcRegisterPatientUtil.updatePatient(request, personService, patient, false);
